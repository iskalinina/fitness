...
var _sliderJury = require("./modules/slider/slider-jury");
var _sliderReviews = require("./modules/slider/slider-reviews");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _sliderJury.initSliderJury)();
  (0, _sliderReviews.initSliderReviews)();
  (0, _initVideo.setupVideo)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/slider/slider-jury":11,"./modules/slider/slider-reviews":12,"./modules/tabs/init-tabs":13,"./modules/video/init-video":15,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  var submitButton = document.querySelector('[data-submit="submit"]');
  submitButton.disabled = true;
  var url = 'https://echo.htmlacademy.ru/';
  var formData = new FormData(document.querySelector('[data-form="data-form"]'));
  fetch(url, {
    method: 'POST',
    body: formData
...
var sliderJury = document.querySelector('[data-slider="jury"]');
var buttonNext = document.querySelector('[data-button="jury-next"]');
var buttonPrev = document.querySelector('[data-button="jury-prev"]');
...
var buttonPrev = document.querySelector('[data-button="reviews-prev"]');
var buttonNext = document.querySelector('[data-button="reviews-next"]');
var initSliderReviews = exports.initSliderReviews = function initSliderReviews() {
  if (sliderReviews) {
    // eslint-disable-next-line
...
var poster = video.querySelector('[data-poster="poster"]');
var button = video.querySelector('[data-button="play-button"]');
